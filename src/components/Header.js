    ...
    return (    
        <header className="h-[5rem] mx-auto shadow-xl flex flex-col justify-center bg-[#F3F8FF] w-full max overflow-hidden z-50">
            <div className={`h-full flex justify-evenly ${isMobile ? 'w-full' : 'w-11/12'} mx-auto`}>
                ...
                {!isMobile &&
                <h1 className=' w-1/3 font-bold text-2xl flex flex-col justify-center h-full text-right text-black font-merriweather ' style={{color: 'black', marginLeft: '50px'}}>MUMBAI FLOOD EXPERIMENT</h1> }
