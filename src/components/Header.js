        ...
        <header className="h-[5rem] mx-auto shadow-xl flex flex-col justify-center bg-[#F3F8FF] w-full max overflow-hidden z-20 mb-2">
            <div className={`h-full flex justify-evenly ${isMobile ? 'w-full' : 'w-11/12'} mx-auto`}>
                <div className='h-full flex gap-5 mt-[.5rem]'>
                    <Link to="https://www.iitb.ac.in/"><img src="/img/iitb copy.png" alt="logo" className='' style={{ height: '3.5rem' }}/></Link>
                ...
                <ul className="flex w-1/3 space-x-5 h-full justify-end">
                    <li className='flex flex-col justify-center'>
                     ...
                     <li className='flex flex-col justify-center'>
                        <Link to="/train" className="p-2 rounded-xl text-black bold text-lg flex flex-col justify-center hover:bg-blue-200 hover:text-black font-serif">Train</Link>
                    </li>
                    {/* <li className='flex flex-col justify-center'>
